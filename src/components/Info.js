  ...
  return (
    <section id="about" className="info">
      <h2 className="info__title">
        Комплекс решений Stream Payments, включает в себя прием платежей по
        классической мобильной коммерции и оплату контентных услуг операторов
        BIG4
      </h2>
      {window.width > 500 && (
        <div className="info__table">
          <div className="info__item">
            ...
            <p className="content__text content__text_place_info">
              Комбинируем различные методы оплаты делая их удобнее для клиента и
              увеличивая конверсию успешных платежей.
            </p>
          </div>
          <div className="info__item">
          ...
          <div className="info__item">
            ...
            <p className="content__text content__text_place_info">
              Простое и гибкое решение оплаты услуг по SMS на короткий номер,
              отправка кода для привязки телефона или для доступа после покупки.
            </p>
          </div>
          <div className="info__item">
            ...
            <p className="content__text content__text_place_info">
              Для проверенных партнёров рассмотрим возможность проведения оплат
              без подтверждения списания.
            </p>
          </div>
        </div>
      )}
